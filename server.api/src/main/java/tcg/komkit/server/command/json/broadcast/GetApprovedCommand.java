...
public abstract class GetApprovedCommand extends JsonCommand {
	static private final String DESCRIPTION = "Get list of members who have approved a broadcast.";
	static private final String COMMAND = "get-approved";

	public GetApprovedCommand() {
	...
	static public class Response extends JsonResponse {
		...
		@JsonProperty
		public List<String> approved = null;
	}
