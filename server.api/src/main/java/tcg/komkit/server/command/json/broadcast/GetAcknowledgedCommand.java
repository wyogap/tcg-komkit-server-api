...
public abstract class GetAcknowledgedCommand extends JsonCommand {
	static private final String DESCRIPTION = "Get list of members who have acknowledge a broadcast.";
	public static final String COMMAND = "get-acknowledged";

	public GetAcknowledgedCommand() {
	...
	static public class Response extends JsonResponse {
		...
		@JsonProperty
		public List<String> acknowledged = null;
	}
