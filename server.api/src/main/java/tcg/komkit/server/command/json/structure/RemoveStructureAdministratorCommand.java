...
import tcg.komkit.server.command.json.community.RemoveAdministratorCommand;

public abstract class RemoveStructureAdministratorCommand extends RemoveAdministratorCommand {
	static private final String DESCRIPTION = "Remove a user as structure administrator.";
	static private final String COMMAND = "remove-admin";

	public RemoveStructureAdministratorCommand() {
