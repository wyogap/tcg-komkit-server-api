...
public abstract class VerifyReferralCommand extends JsonCommand {
	static private final String DESCRIPTION = "Verify a referral code.";
	static private final String COMMAND = "verify-referral";

	public VerifyReferralCommand() {
