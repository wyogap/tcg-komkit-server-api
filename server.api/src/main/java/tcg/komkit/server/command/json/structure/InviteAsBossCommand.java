...
public abstract class InviteAsBossCommand extends GenerateReferralCommand {
	static private final String DESCRIPTION = "Invite a new user as boss to a structure.";
	static private final String COMMAND = "invite-boss";

	public InviteAsBossCommand() {
