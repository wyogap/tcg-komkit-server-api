...
public abstract class GetDirectMembersCommand extends JsonCommand {
	static private final String DESCRIPTION = "Get direct members of the structure.";
	static private final String COMMAND = "direct-members";

	public GetDirectMembersCommand() {
