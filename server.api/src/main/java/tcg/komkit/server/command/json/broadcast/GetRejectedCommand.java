...
public abstract class GetRejectedCommand extends JsonCommand {
	static private final String DESCRIPTION = "Get list of members who have rejected a broadcast.";
	static private final String COMMAND = "get-rejected";

	public GetRejectedCommand() {
	...
	static public class Response extends JsonResponse {
		...
		@JsonProperty
		public List<String> rejected = null;
	}
