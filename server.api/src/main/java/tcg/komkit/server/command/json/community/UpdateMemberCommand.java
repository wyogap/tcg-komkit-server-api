...
public abstract class UpdateMemberCommand extends JsonCommand {
	static private final String DESCRIPTION = "Update information on a community member.";
	static private final String COMMAND = "update-member";
